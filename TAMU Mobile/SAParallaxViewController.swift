...
public class SAParallaxViewController: UIViewController {
    ...
    public override func viewDidLoad() {
        ...
        view.backgroundColor = UIColor(red: 80.0/255.0, green: 0, blue: 0, alpha: 1.0)
        
        NSLayoutConstraint.applyAutoLayout(view, target: collectionView, top: 64.0, left: 0.0, right: 0.0, bottom: 0.0, height: nil, width: nil)
