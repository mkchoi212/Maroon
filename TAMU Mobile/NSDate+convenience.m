...
-(int)firstWeekDayInMonth {
    ...
    return [gregorian ordinalityOfUnit:NSCalendarUnitWeekday inUnit:NSWeekCalendarUnit forDate:newDate];
}
...
+(NSDate *)dateStartOfWeek {
    ...
    NSDateComponents *componentsStripped = [gregorian components: (NSCalendarUnitDay | NSCalendarUnitMonth | NSCalendarUnitDay)
